...
https://www.youtube.com/playlist?list=PLjtiR7dM6Lgqn2E8E31iqLXFmzcyR-SWU
youtube-dl --no-check-certificate -f 18 -o '%(playlist)s/%(title)s.%(ext)s' https://www.youtube.com/playlist?list=PLjtiR7dM6Lgqn2E8E31iqLXFmzcyR-SWU

# Scrapman trailmakers - starting with jellyfish starting at episode
youtube-dl --no-check-certificate -f 18 -o '%(playlist)s/%(title)s.%(ext)s' https://www.youtube.com/playlist?list=PLjtiR7dM6Lgp2qrCaaHCTjAmW-vC_IO5T
