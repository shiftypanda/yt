...
youtube-dl --no-check-certificate -f 18 --playlist-start 43 -o 'iballisticsquid/scrap mechanic/%(playlist)s/%(upload_date)s - %(title)s.%(ext)s' https://www.youtube.com/playlist?list=PL0hoUWUYryn6lZl1BilQaL29E3L5cfXsK
